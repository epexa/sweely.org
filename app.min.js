...
window.addEventListener('DOMContentLoaded', function () {
	...
	if (!localStorage.cookieAccepted) document.querySelector('.cc-window').style = 'display:flex; opacity: 1; z-index: 2'
	...
	if (!localStorage.lang && browserLang !== pageLang) {
		switch (browserLang) {
			case 'en':
				pathName = '';
...
//	// fill beta form 23sec
//	if (!localStorage.requestBeta) setTimeout(function () {
...
//		if (event.relatedTarget == null && !localStorage.feedback) {
//			$('#modal-feedback').modal('show');
//			document.querySelector('.feedback-greeting button').addEventListener('click', function() {
//				document.querySelector('.feedback-greeting').style = 'opacity: 0; visibility: hidden; z-index: -1';
//				document.querySelector('.feedback-why').style = 'opacity: 1 !important; visibility: visible';
//				localStorage.feedback = true // tepmorary
//			})
//		}
//	}
})
