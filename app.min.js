...
window.addEventListener('DOMContentLoaded', function () {
	...
	document.querySelector('.navbar').onmouseout = function (event) {
		if (event.relatedTarget == null && !localStorage.feedback && document.body.classList[0] != 'modal-open') {
			...
			document.querySelector('.feedback-greeting').querySelectorAll('.btn-send-cause').forEach(function(item) {
				item.addEventListener('click', function() {
					alert('POST request =' + this.getAttribute('data-cause')); // send to backend
			...
			document.querySelector('#button-send-cause').addEventListener('click', function() {
				alert('POST request =' + document.querySelector('#textarea-custom-cause').value);
