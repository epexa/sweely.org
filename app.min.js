...
window.addEventListener('DOMContentLoaded', function () {
	...
	if (!localStorage.cookieAccepted) document.querySelector('.cc-window').style = 'display:flex; opacity: 1'

	document.querySelector('#cookie-btn').addEventListener('click', function () {
		localStorage.cookieAccepted = true;
		document.querySelector('.cc-window').style = 'visibility:hidden; opacity: 0'
	})
